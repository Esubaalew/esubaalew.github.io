...
def build_home(posts: list[dict]):
    ...
    html = render_template(
        ...
        og_image=meta.get("og_image", "/assets/og-image.png"),
...
def build_blog_posts(posts: list[dict]):
    ...
    for post in posts:
        ...
        html = render_template(
            ...
            og_image=post["meta"].get("og:image", "/assets/og-blog.png"),
            og_type="article",
